...
function TodoProvider({ children }) {
  ...
  return <TodoContext.Provider value={{ loading, error, completedTodos, totalTodos, searchValue, setSearchValue, completeTodo, deleteTodo, searchTodos }}>{children}</TodoContext.Provider>;
}
